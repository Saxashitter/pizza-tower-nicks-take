...
HX_LOCAL_STACK_FRAME(_hx_pos_5c74e9f0f4a640e0_140_progress,"sys.thread.EventLoop","progress",0xd3ab8d20,"sys.thread.EventLoop.progress","/usr/local/lib/haxe/std/sys/thread/EventLoop.hx",140,0xbeb01246)
...
bool EventLoop_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::NextEventTime EventLoop_obj::progress(){
            	HX_STACKFRAME(&_hx_pos_5c74e9f0f4a640e0_140_progress)
