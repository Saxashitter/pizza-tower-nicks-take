...
HXLINE( 300)				 ::flixel::util::_FlxSignal::FlxSignalHandler handler = _g3->__get(_g2).StaticCast<  ::flixel::util::_FlxSignal::FlxSignalHandler >();
HXDLIN( 300)				_g2 = (_g2 + 1);
HXLINE( 302)				this->remove(handler->listener);
            			}
            		}
