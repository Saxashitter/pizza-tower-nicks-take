...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("PizzaTower",c1,8f,8e,1f),::ApplicationMain_obj::create_dyn());
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("PizzaTower",c1,8f,8e,1f))
