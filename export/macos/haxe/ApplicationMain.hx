...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PizzaTower", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("PizzaTower", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "PizzaTower";
		app.meta["name"] = "PizzaTower";
